...
- Created: `2022-10-07T04:18:51.247914168Z`
- Virtual Size: ~ 26.96 Mb  
...
```console
libpq-13.8-r0 description:
PostgreSQL libraries

libpq-13.8-r0 webpage:
https://www.postgresql.org/

libpq-13.8-r0 installed size:
328 KiB

libpq-13.8-r0 license:
PostgreSQL
