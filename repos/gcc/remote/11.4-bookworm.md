...
### `gcc:11.4-bookworm` - linux; arm variant v5
...
### `gcc:11.4-bookworm` - linux; arm variant v7
...
### `gcc:11.4-bookworm` - linux; arm64 variant v8
...
### `gcc:11.4-bookworm` - linux; ppc64le
