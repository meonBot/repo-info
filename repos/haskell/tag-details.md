...
```console
$ docker pull haskell@sha256:8bc97636f8ffc4d46187297809ff3f9cc19d17135c030523ef90cf9039c9efce
```
...
```console
$ docker pull haskell@sha256:f5f5ecc5278b49ed803ebd06e81454fbc7efa53d4073a5e065c06c39329f2f85
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **412.0 MB (412028926 bytes)**  
	(compressed transfer size, not on-disk size)
...
# Tue, 13 Jun 2023 06:16:21 GMT
ARG STACK=2.9.3
# Tue, 13 Jun 2023 06:16:21 GMT
ARG STACK_RELEASE_KEY=C5705533DA4F78D8664B5DC0575159689BEFB442
# Tue, 13 Jun 2023 06:16:24 GMT
# ARGS: STACK=2.9.3 STACK_RELEASE_KEY=C5705533DA4F78D8664B5DC0575159689BEFB442
RUN set -eux;     cd /tmp;     ARCH="$(dpkg-architecture --query DEB_BUILD_GNU_CPU)";     STACK_URL="https://github.com/commercialhaskell/stack/releases/download/v${STACK}/stack-${STACK}-linux-$ARCH.tar.gz";     case "$ARCH" in         'aarch64')             STACK_SHA256='161e1638da9efc56319f7225b3652ca3f339bcda9eadc7d6ce512f325b0f014a';             ;;         'x86_64')             STACK_SHA256='938f689dc45e2693ab1ca3ea215790b3786dfd531dcf6c0bf40842c24e579ae9';             ;;         *) echo >&2 "error: unsupported architecture '$ARCH'" ; exit 1 ;;     esac;     curl -sSL "$STACK_URL" -o stack.tar.gz;     echo "$STACK_SHA256 stack.tar.gz" | sha256sum --strict --check;         curl -sSL "$STACK_URL.asc" -o stack.tar.gz.asc;     GNUPGHOME="$(mktemp -d)"; export GNUPGHOME;     gpg --batch --keyserver keyserver.ubuntu.com --receive-keys "$STACK_RELEASE_KEY";     gpg --batch --verify stack.tar.gz.asc stack.tar.gz;     gpgconf --kill all;         tar -xf stack.tar.gz -C /usr/local/bin --strip-components=1 "stack-$STACK-linux-$ARCH/stack";     stack config set system-ghc --global true;     stack config set install-ghc --global false;         rm -rf /tmp/*;         stack --version;
# Tue, 13 Jun 2023 06:16:24 GMT
ARG CABAL_INSTALL=3.8.1.0
...
-	Layers:
	...
	-	`sha256:cea8f764ca15b62aa03a628322588b711de23c57e917c8f14ef8435bd4845270`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70a68f60214249b76c6294ee59a3d3b571c45ea32748bed341dd0cee16f7116e`  
		Last Modified: Tue, 13 Jun 2023 06:25:21 GMT  
		Size: 13.7 MB (13736496 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58071b60bbaee9883f1df399dc45cb18999c01db82a47586a9844d6857c4524d`  
		Last Modified: Tue, 13 Jun 2023 06:25:20 GMT  
		Size: 7.8 MB (7838362 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7a16314e90b2c99cdfc3edd775078877833936dbf759f2b668725a6d32b4b07b`  
		Last Modified: Tue, 13 Jun 2023 06:26:04 GMT  
		Size: 269.3 MB (269274965 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull haskell@sha256:c630da4731735ca243747793224f4046a45385a31b081a0a43dd79dff3666266
```
...
```console
$ docker pull haskell@sha256:25d3ec44458a48eccdbe9a36789e21c33d74d21024589478ecf769d1eabbc565
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **715.4 MB (715411682 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:30ec4b7f46f2c192295482b39dc9c1bac40004544215a7ebdd23b5a848ab8fe1`
-	Default Command: `["ghci"]`
...
# ARGS: CABAL_INSTALL=3.8.1.0 CABAL_INSTALL_RELEASE_KEY=E9EC5616017C3EE26B33468CCE1ED8AE0B011D8C STACK=2.9.3 STACK_RELEASE_KEY=C5705533DA4F78D8664B5DC0575159689BEFB442
RUN set -eux;     cd /tmp;     ARCH="$(dpkg-architecture --query DEB_BUILD_GNU_CPU)";     CABAL_INSTALL_TAR="cabal-install-$CABAL_INSTALL-$ARCH-linux-deb10.tar.xz";     CABAL_INSTALL_URL="https://downloads.haskell.org/~cabal/cabal-install-$CABAL_INSTALL/$CABAL_INSTALL_TAR";     CABAL_INSTALL_SHA256SUMS_URL="https://downloads.haskell.org/~cabal/cabal-install-$CABAL_INSTALL/SHA256SUMS";     case "$ARCH" in         'aarch64')             CABAL_INSTALL_SHA256='c7fa9029f2f829432dd9dcf764e58605fbb7431db79234feb3e46684a9b37214';             ;;         'x86_64')             CABAL_INSTALL_SHA256='c71a1a46fd42d235bb86be968660815c24950e5da2d1ff4640da025ab520424b';             ;;         *) echo >&2 "error: unsupported architecture '$ARCH'"; exit 1 ;;     esac;     curl -fSL "$CABAL_INSTALL_URL" -o cabal-install.tar.gz;     echo "$CABAL_INSTALL_SHA256 cabal-install.tar.gz" | sha256sum --strict --check;         curl -sSLO "$CABAL_INSTALL_SHA256SUMS_URL";     curl -sSLO "$CABAL_INSTALL_SHA256SUMS_URL.sig";     GNUPGHOME="$(mktemp -d)"; export GNUPGHOME;     gpg --batch --keyserver keyserver.ubuntu.com --receive-keys "$CABAL_INSTALL_RELEASE_KEY";     gpg --batch --verify SHA256SUMS.sig SHA256SUMS;     grep "$CABAL_INSTALL_SHA256  $CABAL_INSTALL_TAR" SHA256SUMS;     gpgconf --kill all;         tar -xf cabal-install.tar.gz -C /usr/local/bin;         rm -rf /tmp/*;         cabal --version
# Tue, 13 Jun 2023 06:20:50 GMT
ARG LLVM_VERSION=12
# Tue, 13 Jun 2023 06:20:50 GMT
ARG LLVM_KEY=6084F3CF814B57C1CF12EFD515CF4D18AF4F7421
# Tue, 13 Jun 2023 06:20:51 GMT
...
-	Layers:
	...
	-	`sha256:5fa6f8017e9cc962886afb124274faf799e6e1fd9c94fee0e41f81a0b5a3bfe7`  
		...
		Size: 7.8 MB (7838352 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0de6e8823d28d38cee11c85950fe1bfdfb48e42ff2094ed57a3958260dbd1cf3`  
		Last Modified: Tue, 13 Jun 2023 06:30:06 GMT  
		Size: 381.5 MB (381547243 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull haskell@sha256:cacbf92dee4b98b3b4c82654334dc28657c59e1c5b17a51c24873f8bf45ff201
```
...
```console
$ docker pull haskell@sha256:05db4692d75e3519eb5b775f96028ea3c3d701fa44767debd2833faac48ea886
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **407.9 MB (407879234 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ca557756f1f24115f49715bb3f4010ca5eb21306e6fac1cf74f2518d779290d0`
-	Default Command: `["ghci"]`
...
# Tue, 13 Jun 2023 06:23:28 GMT
ENV PATH=/root/.cabal/bin:/root/.local/bin:/opt/ghc/9.0.2/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Tue, 13 Jun 2023 06:23:29 GMT
CMD ["ghci"]
```
...
-	Layers:
	...
	-	`sha256:58071b60bbaee9883f1df399dc45cb18999c01db82a47586a9844d6857c4524d`  
		...
		Size: 7.8 MB (7838362 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:efd6680228fdaa3087e2a22161aa9b572c7d090e4dc02b76d0885e38281919c9`  
		Last Modified: Tue, 13 Jun 2023 06:31:09 GMT  
		Size: 265.1 MB (265125273 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull haskell@sha256:e2cc49600c6998b4b0a99852a6f1a8ef0ee7468106157cc4ec37804296a60662
```
...
```console
$ docker pull haskell@sha256:48dedc551778cbaa6e5987bc9849ae47fb9423664e5f1919641a12d5a1ff4fb5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **420.2 MB (420226882 bytes)**  
	(compressed transfer size, not on-disk size)
...
# ARGS: CABAL_INSTALL=3.8.1.0 CABAL_INSTALL_RELEASE_KEY=E9EC5616017C3EE26B33468CCE1ED8AE0B011D8C STACK=2.9.3 STACK_RELEASE_KEY=C5705533DA4F78D8664B5DC0575159689BEFB442
RUN set -eux;     cd /tmp;     ARCH="$(dpkg-architecture --query DEB_BUILD_GNU_CPU)";     CABAL_INSTALL_TAR="cabal-install-$CABAL_INSTALL-$ARCH-linux-deb10.tar.xz";     CABAL_INSTALL_URL="https://downloads.haskell.org/~cabal/cabal-install-$CABAL_INSTALL/$CABAL_INSTALL_TAR";     CABAL_INSTALL_SHA256SUMS_URL="https://downloads.haskell.org/~cabal/cabal-install-$CABAL_INSTALL/SHA256SUMS";     case "$ARCH" in         'aarch64')             CABAL_INSTALL_SHA256='c7fa9029f2f829432dd9dcf764e58605fbb7431db79234feb3e46684a9b37214';             ;;         'x86_64')             CABAL_INSTALL_SHA256='c71a1a46fd42d235bb86be968660815c24950e5da2d1ff4640da025ab520424b';             ;;         *) echo >&2 "error: unsupported architecture '$ARCH'"; exit 1 ;;     esac;     curl -fSL "$CABAL_INSTALL_URL" -o cabal-install.tar.gz;     echo "$CABAL_INSTALL_SHA256 cabal-install.tar.gz" | sha256sum --strict --check;         curl -sSLO "$CABAL_INSTALL_SHA256SUMS_URL";     curl -sSLO "$CABAL_INSTALL_SHA256SUMS_URL.sig";     GNUPGHOME="$(mktemp -d)"; export GNUPGHOME;     gpg --batch --keyserver keyserver.ubuntu.com --receive-keys "$CABAL_INSTALL_RELEASE_KEY";     gpg --batch --verify SHA256SUMS.sig SHA256SUMS;     grep "$CABAL_INSTALL_SHA256  $CABAL_INSTALL_TAR" SHA256SUMS;     gpgconf --kill all;         tar -xf cabal-install.tar.gz -C /usr/local/bin;         rm -rf /tmp/*;         cabal --version
# Tue, 13 Jun 2023 06:19:26 GMT
ARG GHC=9.2.7
# Tue, 13 Jun 2023 06:19:26 GMT
ARG GHC_RELEASE_KEY=88B57FCF7DB53B4DB3BFA4B1588764FBE22D19C4
# Tue, 13 Jun 2023 06:20:33 GMT
# ARGS: CABAL_INSTALL=3.8.1.0 CABAL_INSTALL_RELEASE_KEY=E9EC5616017C3EE26B33468CCE1ED8AE0B011D8C GHC=9.2.7 GHC_RELEASE_KEY=88B57FCF7DB53B4DB3BFA4B1588764FBE22D19C4 STACK=2.9.3 STACK_RELEASE_KEY=C5705533DA4F78D8664B5DC0575159689BEFB442
RUN set -eux;     cd /tmp;     ARCH="$(dpkg-architecture --query DEB_BUILD_GNU_CPU)";     GHC_URL="https://downloads.haskell.org/~ghc/$GHC/ghc-$GHC-$ARCH-deb10-linux.tar.xz";     case "$ARCH" in         'aarch64')             GHC_SHA256='b4829dd2f4bdaa4b21b22b50edec17616848ab22ab64188047a3eb12bb4da85a';             ;;         'x86_64')             GHC_SHA256='3a76ad6b96915eebf960d1b757ee57341302a76c6a8f97af63fd84eddb45362b';             ;;         *) echo >&2 "error: unsupported architecture '$ARCH'" ; exit 1 ;;     esac;     curl -sSL "$GHC_URL" -o ghc.tar.xz;     echo "$GHC_SHA256 ghc.tar.xz" | sha256sum --strict --check;         GNUPGHOME="$(mktemp -d)"; export GNUPGHOME;     curl -sSL "$GHC_URL.sig" -o ghc.tar.xz.sig;     gpg --batch --keyserver keyserver.ubuntu.com --receive-keys "$GHC_RELEASE_KEY";     gpg --batch --verify ghc.tar.xz.sig ghc.tar.xz;     gpgconf --kill all;         tar xf ghc.tar.xz;     cd "ghc-$GHC";     ./configure --prefix "/opt/ghc/$GHC";     make install;     find "/opt/ghc/$GHC/" \( -name "*_p.a" -o -name "*.p_hi" \) -type f -delete;         rm -rf /tmp/*;         "/opt/ghc/$GHC/bin/ghc" --version
# Tue, 13 Jun 2023 06:20:40 GMT
ENV PATH=/root/.cabal/bin:/root/.local/bin:/opt/ghc/9.2.7/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Tue, 13 Jun 2023 06:20:40 GMT
CMD ["ghci"]
```
...
-	Layers:
	...
	-	`sha256:58071b60bbaee9883f1df399dc45cb18999c01db82a47586a9844d6857c4524d`  
		...
		Size: 7.8 MB (7838362 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:359b05d56a40de5a9f6ffe14c2912a53f05c6374de8bdc41e24b571154041933`  
		Last Modified: Tue, 13 Jun 2023 06:28:42 GMT  
		Size: 277.5 MB (277472921 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
