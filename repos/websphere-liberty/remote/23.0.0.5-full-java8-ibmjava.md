...
### `websphere-liberty:23.0.0.5-full-java8-ibmjava` - linux; amd64
...
### `websphere-liberty:23.0.0.5-full-java8-ibmjava` - linux; ppc64le
...
### `websphere-liberty:23.0.0.5-full-java8-ibmjava` - linux; s390x
