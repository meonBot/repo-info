...
```console
$ docker pull mono@sha256:ac44a41003748d46fe21a4ec36f9fc6f30652c84b65830930806cc9664668009
```
...
```console
$ docker pull mono@sha256:1f3e9e43e9c8d667b808224d8b92a601de46d2b68c941fa3ff01cc05efb1ce4d
```
