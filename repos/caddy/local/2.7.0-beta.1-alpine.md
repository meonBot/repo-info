...
- Created: `2023-05-17T23:20:12.138158824Z`
- Virtual Size: ~ 48.93 Mb  
  (total size of all layers on-disk)
- Arch: `linux`/`amd64`
- Command: `["caddy","run","--config","/etc/caddy/Caddyfile","--adapter","caddyfile"]`
- Environment:
  - `PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin`
  - `CADDY_VERSION=v2.7.0-beta.1`
...
- Labels:
  ...
  - `org.opencontainers.image.version=v2.7.0-beta.1`
...
```console
mailcap-2.1.53-r1 description:
Helper application and MIME type associations for file types

mailcap-2.1.53-r1 webpage:
https://pagure.io/mailcap

mailcap-2.1.53-r1 installed size:
84 KiB

mailcap-2.1.53-r1 license:
Public Domain
